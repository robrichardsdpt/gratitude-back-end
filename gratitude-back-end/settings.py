"""
Django settings for gratitude-back-end project.
...
if os.getenv('ENV') == 'development':
  ...
  CORS_ORIGIN_WHITELIST = [
    os.getenv('https://robrichardsdpt.github.io/gratitude-app')
  ]
...
ROOT_URLCONF = 'gratitude-back-end.urls'
...
WSGI_APPLICATION = 'gratitude-back-end.wsgi.application'
